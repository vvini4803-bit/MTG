...
export const SEED_USERS: UserProfile[] = [
  ...
  },
  {
    ...
    name_kn: 'ಮುತ್ತಾಗೊಂದಿ ಆಡಳಿತಾಧಿಕಾರಿ',
    phone: '+91 7483254968',
  ...
  },
  {
    ...
    name: 'Ramesh Kumar',
    name_kn: 'ರಮೇಶ್ ಕುಮಾರ್ (ರೈತರು)',
    phone: '+91 7483254968',
    role: 'USER',
    language: 'kn',
    photoUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150',
    bio: 'Organic Arecanut & Coconut farmer in Central Muttagundi',
    bio_kn: 'ಮುತ್ತಾಗೊಂದಿ ಗ್ರಾಮದ ಸಾವಯವ ಅಡಿಕೆ & ತೆಂಗು ಬೆಳೆಗಾರರು',
    account_status: 'ACTIVE',
    created_at: new Date().toISOString(),
    last_login: new Date().toISOString(),
    is_phone_verified: true,
  ...
  },
  {
    ...
    name: 'Manjunatha M',
    name_kn: 'ಮಂಜುನಾಥ ಎಂ (ಕ್ರೀಡಾಪಟು)',
    phone: '+91 7483254968',
    role: 'SPORTS_ORGANIZER',
    language: 'kn',
    photoUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150',
    bio: 'Village Kabaddi & Cricket team captain, Hosadurga Taluk runner-up',
    bio_kn: 'ಮುತ್ತಾಗೊಂದಿ ಕಬಡ್ಡಿ & ಕ್ರಿಕೆಟ್ ತಂಡದ ನಾಯಕರು',
    account_status: 'ACTIVE',
    created_at: new Date().toISOString(),
    last_login: new Date().toISOString(),
    is_phone_verified: true,
  ...
  },
  {
    ...
    name: 'Sowmya Devi',
    name_kn: 'ಸೌಮ್ಯ ದೇವಿ (ಶಿಕ್ಷಕರು)',
    phone: '+91 7483254968',
    role: 'USER',
    language: 'kn',
    photoUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150',
    bio: 'Primary School Teacher, Govt Lower Primary School Muttagundi',
    bio_kn: 'ಸರ್ಕಾರಿ ಕಿರಿಯ ಪ್ರಾಥಮಿಕ ಶಾಲೆ ಶಿಕ್ಷಕಿ, ಮುತ್ತಾಗೊಂದಿ',
    account_status: 'ACTIVE',
    created_at: new Date().toISOString(),
    last_login: new Date().toISOString(),
    is_phone_verified: true,
  ...
  },
  {
    ...
    name: 'Basavaraju K',
    name_kn: 'ಬಸವರಾಜು ಕೆ (ಗ್ರಾಮಸ್ಥರು)',
    phone: '+91 7483254968',
    role: 'USER',
    language: 'kn',
    photoUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150',
    bio: 'Temple seva volunteer & community social coordinator',
    bio_kn: 'ದೇವಸ್ಥಾನ ಸೇವಾ ಸಮಿತಿ ಸದಸ್ಯರು & ಸಮಾಜ ಸೇವಕರು',
    account_status: 'ACTIVE',
    created_at: new Date().toISOString(),
    last_login: new Date().toISOString(),
    is_phone_verified: true,
...
export const SEED_NEWS: NewsItem[] = [
  {
    ...
    title_kn: 'ಮುತ್ತಾಗೊಂದಿ ಗ್ರಾಮ ಸಭೆ ಮತ್ತು ಗ್ರಾಮ ಅಭಿವೃದ್ಧಿ ಸಭೆ ನಿಗದಿಯಾಗಿದೆ',
    ...
    content_kn: 'ಮುತ್ತಾಗೊಂದಿ ಗ್ರಾಮದ ಅಧಿಕೃತ ಗ್ರಾಮ ಸಭೆಯು ಮುಂಬರುವ ಭಾನುವಾರ ಬೆಳಿಗ್ಗೆ 10:00 ಗಂಟೆಗೆ ಗ್ರಾಮದ ಸಮುದಾಯ ಭವನದಲ್ಲಿ ನಡೆಯಲಿದೆ. ರಸ್ತೆ ದುರಸ್ತಿ, ಕುಡಿಯುವ ನೀರಿನ ಸೌಲಭ್ಯ, ಮತ್ತು ಕೃಷಿ ಯೋಜನೆಗಳ ಕುರಿತು ಚರ್ಚಿಸಲು ಎಲ್ಲಾ ಗ್ರಾಮಸ್ಥರು, ರೈತ ಬಾಂಧವರು ಹಾಗೂ ಯುವಕರು ಭಾಗವಹಿಸಲು ಕೋರಲಾಗಿದೆ.',
    category: 'COMMUNITY',
  ...
  },
  {
    ...
    content_kn: 'ಕೃಷಿ ಇಲಾಖೆಯ ವತಿಯಿಂದ ಮುತ್ತಾಗೊಂದಿ ಗ್ರಾಮದ ರೈತರಿಗೆ ಉಚಿತ ಮಣ್ಣು ಪರೀಕ್ಷೆ ಶಿಬಿರ ಹಾಗೂ ರಿಯಾಯಿತಿ ದರದಲ್ಲಿ ಗುಣಮಟ್ಟದ ರಾಗಿ, ಕಡಲೆಕಾಯಿ ಹಾಗೂ ಮೆಕ್ಕೆಜೋಳ ಬೀಜ ವಿತರಣೆ ಈ ವಾರ ನಡೆಯಲಿದೆ.',
  ...
  },
  {
    ...
    content_kn: 'ಮುತ್ತಾಗೊಂದಿ ಗ್ರಾಮದ ಶುದ್ಧ ಕುಡಿಯುವ ನೀರಿನ ಘಟಕದ ಫಿಲ್ಟರ್ ಬದಲಾವಣೆ ಹಾಗೂ ಪೈಪ್‌ಲೈನ್ ನಿರ್ವಹಣಾ ಕಾರ್ಯ ಯಶಸ್ವಿಯಾಗಿ ಪೂರ್ಣಗೊಂಡಿದೆ. ಕುಡಿಯುವ ನೀರಿನ ಸರಬರಾಜು ಸಹಜ ಸ್ಥಿತಿಗೆ ಮರಳಿದೆ.',
    category: 'WATER',
